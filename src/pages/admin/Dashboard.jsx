...
// edwind, esta función convierte fechas feas en algo bonito como "Hace 2 horas"
...
// edwind, esto muestra unas cajitas grises mientras carga la actividad
...
// edwind, el componente para cada cuadrito de estadística arriba
function StatCard({ id, label, value, icon, color, sub, loading }) {
  // edwind, hacemos este renombramiento para que las mayúsculas funcionen bien con los íconos
  const Icon = icon;
  return (
    <div
      id={id}
...
// edwind, la lista de qué tan frescas están las noticias
...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    async function fetchDashboard() {
      try {
        // edwind, llamamos a todo al mismo tiempo para que cargue volando
    ...
    <div>
      <div className="mb-6">
        ...
        <p className="text-gray-500 text-sm mt-1">
          Resumen general del portal municipal
        </p>
      </div>

      {/* edwind, por si acaso hubo un error feo y hay que mostrarlo arriba */}
      {error && (
      ...
      {/* edwind, la cuadrícula donde metemos todos los cuadritos de colores */}
      ...
      {/* edwind, y abajo la listita con las últimas noticias */}
      <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
        ...
        {loading ? (
          ...
          <ActivityList recientes={recientes} />
        )}
      </div>
    </div>
  );
