  ...
  return (
    <div className="min-h-screen bg-marcona-light flex flex-col">
      ...
      <header className="bg-marcona-blue py-4 px-6 flex items-center gap-3 shadow">
        ...
        <div>
          <p className="text-white/70 text-[10px] uppercase tracking-widest">Municipalidad Distrital de</p>
          <p className="text-white font-black text-sm uppercase tracking-tight">Marcona</p>
        </div>
        <Link to="/" className="ml-auto text-white/60 hover:text-white text-xs transition-colors">
          ← Volver al inicio
        </Link>
      </header>
      ...
      <div className="flex-1 flex items-center justify-center p-4">
        <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm p-8">
          ...
          <h1 className="text-xl font-extrabold text-gray-900 text-center mb-1">Portal del Ciudadano</h1>
          <p className="text-gray-400 text-xs text-center mb-6">Ingresa con tus credenciales municipales</p>
          ...
          <p className="text-center text-gray-400 text-xs mt-6">
            ...
            <a href="/contacto" className="text-marcona-blue font-medium hover:underline">
              Contactar soporte
            </a>
          </p>
        </div>
